...
public class LightyDiagStatusServiceImplTest {
    ...
    public void registerTest() {
        ...
        diagStatusService.register(TEST_SERVICE).report(new ServiceDescriptor(TEST_SERVICE_2, ServiceState.STARTING, TEST_SERVICE_2_INFO));
    ...
    public void reportTest() {
        ...
        validateServiceStatus(diagStatusService.getServiceStatusSummary(), false, ServiceState.STARTING);
        diagStatusService.register(TEST_SERVICE_2).report(new ServiceDescriptor(TEST_SERVICE_2, ServiceState.OPERATIONAL, TEST_SERVICE_2_INFO));
